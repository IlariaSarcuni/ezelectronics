...
import { UserNotFoundError, UserNotManagerError, UserNotCustomerError, UserAlreadyExistsError, UserNotAdminError, UserIsAdminError, UnauthorizedUserError, BadRequestError} from "../errors/userError";
import { CustomError, DateError } from "../utilities";
...
class UserController {
    ...
    async getUsersByRole(role: string) /**:Promise<User[]> */ {
        const allowedRoles = ["Manager", "Customer", "Admin"];
