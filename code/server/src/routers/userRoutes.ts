...
import { UserAlreadyExistsError, UserNotFoundError, UnauthorizedUserError, UserIsAdminError} from "../errors/userError";
...
class UserRoutes {
    ...
    initRoutes() {
        ...
        this.router.post(
            "/",
            body("username").notEmpty().withMessage("Username must be provided and cannot be empty."),
            body("name").notEmpty().withMessage("Name must be provided and cannot be empty."),
            body("surname").notEmpty().withMessage("Surname must be provided and cannot be empty."),
            body("password").notEmpty().withMessage("Password must be provided and cannot be empty."),
            body("role").notEmpty().isIn(['Manager', 'Customer', 'Admin']).withMessage("Role must be provided and cannot be empty."),
        ...
        this.router.get(
            "/",
            this.authService.isAdmin,   // Middleware to check if the user is an admin    
        ...
        this.router.get(
            "/roles/:role",
            param("role").notEmpty().isIn(['Manager', 'Customer', 'Admin']).withMessage("Role must be provided and cannot be empty and it must be manager, customer or admin."),
            this.authService.isAdmin,   // Middleware to check if the user is an admin    
            this.errorHandler.validateRequest,
        ...
        this.router.get(
            "/:username",
            param("username").notEmpty().withMessage("Username must be provided and cannot be empty."),
            this.authService.isLoggedIn, // Middleware to check if the user is admin
            this.errorHandler.validateRequest,
        ...
        this.router.patch(
            ...
            body("name").notEmpty().withMessage("Name must be provided and cannot be empty."),
            body("surname").notEmpty().withMessage("Surname must be provided and cannot be empty."),
            body("address").notEmpty().withMessage("Address must be provided and cannot be empty."),
            body("birthdate").notEmpty().withMessage("Birthdate must be provided and cannot be empty.").isDate().withMessage("Birthdate must be a valid date."),
            this.authService.isLoggedIn, // Middleware to check if the user is logged in
            this.errorHandler.validateRequest,
